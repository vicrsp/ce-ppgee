...
class GA:
    ...
    def run(self, debug=False):
        ...
        for generation in range(self.num_generations):
            ...
            # Mutation
            offspring_mutated = self.flip_bit_mutation_per_bit(
        ...
        for i in range(num_offsprings):
            for var_index in range(self.num_variables):
                ...
                for k in range(self.num_bits):
                    ...
                    mutated = not chromosome if prob < pm else chromosome
    ...
    def get_mutation_probability(self, generation):
        if(self.min_mutation_probability == self.max_mutation_probability):
            return 0.0
    ...
    def get_crossover_probability(self, generation):
        if(self.min_crossover_probability == self.max_crossover_probability):
            return 0.0
